  <header class="span12">
  	...
  	<nav class="col center">
        ...
        <!--[if lt IE 7 ]> <div class="logocontain"><a class="alt logo" href="index.php"><img class='logoimg' src="Audio-Visions-WebIE.png" alt="logo"></a> </div><![endif]-->
        <!--[if IE 7 ]>    <div class="logocontain"><a class="alt logo" href="index.php"><img class='logoimg' src="Audio-Visions-WebIE.png" alt="logo"></a> </div><![endif]-->
        <!--[if IE 8 ]>    <a class="alt logo" href="index.php"><img class='logoimg' src="Audio-Visions-Web.png" alt="logo" width="200" height="100"></a> <![endif]-->
